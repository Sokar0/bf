...
describe('test AssetController', () => {
  let instance: FastifyInstanceWithController<AssetController>;
  ...
  it('should properly return an empty Asset list', async () => {
  ...
  it('should properly return a 404 regarding the request of a Asset based on its id', async () => {
    expect.hasAssertions();
  ...
  it('should properly return a 200 regarding the creation of a Asset', async () => {
    expect.hasAssertions();
  ...
  it('should properly return a 200 regarding the update of a Asset', async () => {
    expect.hasAssertions();
  ...
  it('should properly return a 200 regarding the deletion of a Asset', async () => {
    expect.hasAssertions();
